...
initial equation
  ...
  Tp = iTp;
annotation(
    Icon(graphics = {Ellipse(origin = {80, 60}, fillColor = {238, 238, 236}, fillPattern = FillPattern.Solid, lineThickness = 0.5, extent = {{-12, 10}, {8, -10}}, endAngle = 360), Text(origin = {62, 84}, lineColor = {92, 53, 102}, extent = {{-12, 14}, {44, -14}}, textString = "N"), Ellipse(origin = {80, 0}, fillColor = {238, 238, 236}, fillPattern = FillPattern.Solid, lineThickness = 0.5, extent = {{-12, 10}, {8, -10}}, endAngle = 360), Ellipse(origin = {80, -60}, fillColor = {238, 238, 236}, fillPattern = FillPattern.Solid, lineThickness = 0.5, extent = {{-12, 10}, {8, -10}}, endAngle = 360)}, coordinateSystem(initialScale = 0.1)),
    experiment(StartTime = 0, StopTime = 1, Tolerance = 1e-6, Interval = 0.002),
    __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian,newInst",
    __OpenModelica_simulationFlags(lv = "LOG_STATS", outputFormat = "mat", s = "dassl"));
end Probe3Ts_lag_noise;
