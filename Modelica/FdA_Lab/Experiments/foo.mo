...
model foo
  ...
  Modelica.Blocks.Sources.RealExpression SP_Tp(y = 300) annotation(
...
equation
  ...
  connect(SP_Tp.y, PI.SP) annotation(
    Line(points = {{-159, 18}, {-141.5, 18}, {-141.5, 24}, {-124, 24}}, color = {0, 0, 127}));
  connect(Probes.oTpm, PI.PV) annotation(
    Line(points = {{104, -12}, {120, -12}, {120, -40}, {-142, -40}, {-142, 0}, {-124, 0}}, color = {92, 53, 102}));
  annotation(
    Diagram(coordinateSystem(extent = {{-200, -100}, {200, 100}})),
    experiment(StartTime = 0, StopTime = 1000, Tolerance = 1e-6, Interval = 1),
